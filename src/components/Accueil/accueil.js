...
export default function Accueil() {
  return (
    <div id="Frame" data-name="Accueil" className="Frame">
      ...
      <div className="Group-3-outer">
        <div id="Group-3" data-name="Group 3" className="Group-3">
          <div className="Apprendre-le-Legal-d-outer">
            <div
              id="Apprendre-le-Legal-d"
              data-name="Apprendre le Legal design"
              className="Apprendre-le-Legal-d"
            >
              <div key="0">Apprendre le Legal design</div>
            </div>
          </div>
          <div className="Lorem-ipsum-dolor-si-5-outer">
            <div
              id="Lorem-ipsum-dolor-si-5"
              ...
              className="Lorem-ipsum-dolor-si-5"
            >
              <div key="0">
      ...
      <div className="Rectangle-60-outer">
        <div
          id="Rectangle-60"
      ...
      <div className="Envie-de-faire-parti-outer">
        <div
          id="Envie-de-faire-parti"
          data-name="Envie de faire partie des XXX abonnés à ce cours ?"
          className="Envie-de-faire-parti"
        >
          <div key="0">Envie de faire partie des XXX abonnés à ce cours ? </div>
        </div>
      </div>
